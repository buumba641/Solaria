 ...
 * POST /api/chat
 *
 * Stub endpoint — the Android app handles AI chat locally via OfflineAiEngine
 * (pattern matching + Gemini 1.5 Flash fallback). This endpoint exists for
 * API contract compatibility and can be replaced with a server-side LLM
